        ...
        <div class="grid sm:grid-cols-12 gap-8 py-8 md:py-12">
            ...
            <div class="sm:col-span-12 lg:col-span-4 order-1 lg:order-none">
                <div class="h-full flex flex-col sm:flex-row lg:flex-col justify-between">
                    <div class="mb-4 sm:mb-0">
                        <div class="mb-4">
                            ...
                            <a class="inline-flex" href="/" aria-label="Common Sense Coding">
                                <img src="/src/lib/assets/images/logo.svg" width="38" height="38" alt="Stellar">
                            </a>
                        </div>
                    ...
                    <ul class="flex">
                        <li>
                            <a class="flex justify-center items-center text-purple-500 hover:text-purple-400 transition duration-150 ease-in-out" href="https://x.com/cscoding21" aria-label="Twitter" target="_blank">
                        ...
                        <li class="ml-2">
                            <a class="flex justify-center items-center text-purple-500 hover:text-purple-400 transition duration-150 ease-in-out" href="https://dev.to/cscoding21" aria-label="Dev.to" target="_blank">
                        ...
                        <li class="ml-2">
                            <a class="flex justify-center items-center text-purple-500 hover:text-purple-400 transition duration-150 ease-in-out" href="https://github.com/cscoding21" aria-label="Github" target="_blank">
                                <svg class="w-8 h-8 fill-current" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
