                    ...
                    <div class="md:grow pb-12 md:pb-20">
                        <div class="max-w-3xl">
                            ...
                            <article class="pb-12 mb-12 border-b [border-image:linear-gradient(to_right,transparent,var(--color-slate-800),transparent)1]">
                                ...
                                <div class="mb-4">
                                    <a class="inline-flex text-sm font-medium text-purple-500 group" href="/customers"><span class="tracking-normal group-hover:-translate-x-0.5 transition-transform duration-150 ease-in-out mr-1">&lt;-</span> Go Back</a>
                                </div>
