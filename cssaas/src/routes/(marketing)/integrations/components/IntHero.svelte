                ...
                <div class="swiper-wrapper w-fit">
                        ...
                        <div class="flex flex-col p-5 h-full">
                            ...
                            <div class="flex justify-between">
                                <div class="flex -space-x-3 -ml-0.5">
                                    <img class="rounded-full border-2 border-slate-800 box-content" src="/src/lib/assets/images/avatar-01.jpg" width="24" height="24" alt="Avatar 01">
                                    <img class="rounded-full border-2 border-slate-800 box-content" src="/src/lib/assets/images/avatar-02.jpg" width="24" height="24" alt="Avatar 02">
                                    <img class="rounded-full border-2 border-slate-800 box-content" src="/src/lib/assets/images/avatar-03.jpg" width="24" height="24" alt="Avatar 03">
                                    <img class="rounded-full border-2 border-slate-800 box-content" src="/src/lib/assets/images/avatar-04.jpg" width="24" height="24" alt="Avatar 04">
                                </div>
                    ...
                    <div class="swiper-slide h-auto bg-linear-to-tr from-slate-800 to-slate-800/25 rounded-3xl border border-slate-800 hover:border-slate-700/60 transition-colors group relative">
                        <div class="flex flex-col p-5 h-full">
                            ...
                            <div class="flex justify-between">
                                <div class="flex -space-x-3 -ml-0.5">
                                    <img class="rounded-full border-2 border-slate-800 box-content" src="/src/lib/assets/images/avatar-05.jpg" width="24" height="24" alt="Avatar 05">
                                    <img class="rounded-full border-2 border-slate-800 box-content" src="/src/lib/assets/images/avatar-06.jpg" width="24" height="24" alt="Avatar 06">
                                    <img class="rounded-full border-2 border-slate-800 box-content" src="/src/lib/assets/images/avatar-07.jpg" width="24" height="24" alt="Avatar 07">
                                </div>
                                <button class="flex items-center space-x-2 font-medium text-sm text-slate-300 hover:text-white transition-colors">
                                    <span class="sr-only">Like</span>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16">
                    ...
                    <div class="swiper-slide h-auto bg-linear-to-tr from-slate-800 to-slate-800/25 rounded-3xl border border-slate-800 hover:border-slate-700/60 transition-colors group relative">
                        <div class="flex flex-col p-5 h-full">
                            ...
                            <div class="flex justify-between">
                                <div class="flex -space-x-3 -ml-0.5">
                                    <img class="rounded-full border-2 border-slate-800 box-content" src="/src/lib/assets/images/avatar-08.jpg" width="24" height="24" alt="Avatar 08">
                                    <img class="rounded-full border-2 border-slate-800 box-content" src="/src/lib/assets/images/avatar-09.jpg" width="24" height="24" alt="Avatar 09">
                                    <img class="rounded-full border-2 border-slate-800 box-content" src="/src/lib/assets/images/avatar-10.jpg" width="24" height="24" alt="Avatar 10">
                                    <img class="rounded-full border-2 border-slate-800 box-content" src="/src/lib/assets/images/avatar-11.jpg" width="24" height="24" alt="Avatar 11">
                                </div>
                                <button class="flex items-center space-x-2 font-medium text-sm text-slate-300 hover:text-white transition-colors">
                                    <span class="sr-only">Like</span>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16">
                    ...
                    <div class="swiper-slide h-auto bg-linear-to-tr from-slate-800 to-slate-800/25 rounded-3xl border border-slate-800 hover:border-slate-700/60 transition-colors group relative">
                        <div class="flex flex-col p-5 h-full">
                            ...
                            <div class="flex justify-between">
                                <div class="flex -space-x-3 -ml-0.5">
                                    <img class="rounded-full border-2 border-slate-800 box-content" src="/src/lib/assets/images/avatar-12.jpg" width="24" height="24" alt="Avatar 12">
                                    <img class="rounded-full border-2 border-slate-800 box-content" src="/src/lib/assets/images/avatar-13.jpg" width="24" height="24" alt="Avatar 13">
                                    <img class="rounded-full border-2 border-slate-800 box-content" src="/src/lib/assets/images/avatar-14.jpg" width="24" height="24" alt="Avatar 14">
                                    <img class="rounded-full border-2 border-slate-800 box-content" src="/src/lib/assets/images/avatar-15.jpg" width="24" height="24" alt="Avatar 15">
                                </div>
                                <button class="flex items-center space-x-2 font-medium text-sm text-slate-300 hover:text-white transition-colors">
                                    <span class="sr-only">Like</span>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16">
                    ...
                    <div class="swiper-slide h-auto bg-linear-to-tr from-slate-800 to-slate-800/25 rounded-3xl border border-slate-800 hover:border-slate-700/60 transition-colors group relative">
                        <div class="flex flex-col p-5 h-full">
                            ...
                            <div class="flex justify-between">
                                <div class="flex -space-x-3 -ml-0.5">
                                    <img class="rounded-full border-2 border-slate-800 box-content" src="/src/lib/assets/images/avatar-16.jpg" width="24" height="24" alt="Avatar 16">
                                    <img class="rounded-full border-2 border-slate-800 box-content" src="/src/lib/assets/images/avatar-17.jpg" width="24" height="24" alt="Avatar 17">
                                    <img class="rounded-full border-2 border-slate-800 box-content" src="/src/lib/assets/images/avatar-18.jpg" width="24" height="24" alt="Avatar 18">
                                    <img class="rounded-full border-2 border-slate-800 box-content" src="/src/lib/assets/images/avatar-19.jpg" width="24" height="24" alt="Avatar 19">
                                </div>
                                <button class="flex items-center space-x-2 font-medium text-sm text-slate-300 hover:text-white transition-colors">
                                    <span class="sr-only">Like</span>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16">
