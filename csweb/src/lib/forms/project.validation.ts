...
import type { UpdateProject, UpdateProjectFeature } from '$lib/graphql/generated/sdk'
...
export const valueSchema = yup.object().shape({
    ...
    discountRate: yup.number().min(0.0, "Discount rate cannot be lower than zero").max(20.0, "Discount rate cannot be higher than 20%").nullable(),
