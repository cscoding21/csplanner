...
export type ProjectDaci = {
	...
	approver?: Maybe<Array<Maybe<Scalars['String']['output']>>>;
	contributor?: Maybe<Array<Maybe<Scalars['String']['output']>>>;
	driver?: Maybe<Array<Maybe<Scalars['String']['output']>>>;
	informed?: Maybe<Array<Maybe<Scalars['String']['output']>>>;
};
...
export type Query = {
	...
	findProjectComments: Array<Comment>;
...
export type UpdateProjectDaci = {
	approver?: InputMaybe<Array<InputMaybe<Scalars['String']['input']>>>;
	contributor?: InputMaybe<Array<InputMaybe<Scalars['String']['input']>>>;
	driver?: InputMaybe<Array<InputMaybe<Scalars['String']['input']>>>;
	informed?: InputMaybe<Array<InputMaybe<Scalars['String']['input']>>>;
};
...
export const CommentFragmentFragmentDoc = gql`
	...
	${ControlFieldsFragmentFragmentDoc}
`;
...
export function getSdk<C>(requester: Requester<C>) {
	return {
		findActivity(variables: FindActivityQueryVariables, options?: C): Promise<FindActivityQuery> {
			return requester<FindActivityQuery, FindActivityQueryVariables>(
				FindActivityDocument,
				variables,
				options
			) as Promise<FindActivityQuery>;
		},
		createProjectComment(
			variables: CreateProjectCommentMutationVariables,
			options?: C
		): Promise<CreateProjectCommentMutation> {
			return requester<CreateProjectCommentMutation, CreateProjectCommentMutationVariables>(
				CreateProjectCommentDocument,
				variables,
				options
			) as Promise<CreateProjectCommentMutation>;
		},
		updateProjectComment(
			variables: UpdateProjectCommentMutationVariables,
			options?: C
		): Promise<UpdateProjectCommentMutation> {
			return requester<UpdateProjectCommentMutation, UpdateProjectCommentMutationVariables>(
				UpdateProjectCommentDocument,
				variables,
				options
			) as Promise<UpdateProjectCommentMutation>;
		},
		createProjectCommentReply(
			variables: CreateProjectCommentReplyMutationVariables,
			options?: C
		): Promise<CreateProjectCommentReplyMutation> {
			return requester<
				CreateProjectCommentReplyMutation,
				CreateProjectCommentReplyMutationVariables
			>(
				CreateProjectCommentReplyDocument,
				variables,
				options
			) as Promise<CreateProjectCommentReplyMutation>;
		},
		deleteProjectComment(
			variables: DeleteProjectCommentMutationVariables,
			options?: C
		): Promise<DeleteProjectCommentMutation> {
			return requester<DeleteProjectCommentMutation, DeleteProjectCommentMutationVariables>(
				DeleteProjectCommentDocument,
				variables,
				options
			) as Promise<DeleteProjectCommentMutation>;
		},
		findProjectComments(
			variables: FindProjectCommentsQueryVariables,
			options?: C
		): Promise<FindProjectCommentsQuery> {
			return requester<FindProjectCommentsQuery, FindProjectCommentsQueryVariables>(
				FindProjectCommentsDocument,
				variables,
				options
			) as Promise<FindProjectCommentsQuery>;
		},
		getCommentThread(
			variables: GetCommentThreadQueryVariables,
			options?: C
		): Promise<GetCommentThreadQuery> {
			return requester<GetCommentThreadQuery, GetCommentThreadQueryVariables>(
				GetCommentThreadDocument,
				variables,
				options
			) as Promise<GetCommentThreadQuery>;
		},
		findAllLists(variables?: FindAllListsQueryVariables, options?: C): Promise<FindAllListsQuery> {
			return requester<FindAllListsQuery, FindAllListsQueryVariables>(
				FindAllListsDocument,
				variables,
				options
			) as Promise<FindAllListsQuery>;
		},
		getList(variables: GetListQueryVariables, options?: C): Promise<GetListQuery> {
			return requester<GetListQuery, GetListQueryVariables>(
				GetListDocument,
				variables,
				options
			) as Promise<GetListQuery>;
		},
		findUserNotifications(
			variables: FindUserNotificationsQueryVariables,
			options?: C
		): Promise<FindUserNotificationsQuery> {
			return requester<FindUserNotificationsQuery, FindUserNotificationsQueryVariables>(
				FindUserNotificationsDocument,
				variables,
				options
			) as Promise<FindUserNotificationsQuery>;
		},
		setNotificationsRead(
			variables: SetNotificationsReadMutationVariables,
			options?: C
		): Promise<SetNotificationsReadMutation> {
			return requester<SetNotificationsReadMutation, SetNotificationsReadMutationVariables>(
				SetNotificationsReadDocument,
				variables,
				options
			) as Promise<SetNotificationsReadMutation>;
		},
		portfolioSnapshot(
			variables?: PortfolioSnapshotQueryVariables,
			options?: C
		): Promise<PortfolioSnapshotQuery> {
			return requester<PortfolioSnapshotQuery, PortfolioSnapshotQueryVariables>(
				PortfolioSnapshotDocument,
				variables,
				options
			) as Promise<PortfolioSnapshotQuery>;
		},
		resourceSnapshot(
			variables?: ResourceSnapshotQueryVariables,
			options?: C
		): Promise<ResourceSnapshotQuery> {
			return requester<ResourceSnapshotQuery, ResourceSnapshotQueryVariables>(
				ResourceSnapshotDocument,
				variables,
				options
			) as Promise<ResourceSnapshotQuery>;
		},
		findProjects(variables: FindProjectsQueryVariables, options?: C): Promise<FindProjectsQuery> {
			return requester<FindProjectsQuery, FindProjectsQueryVariables>(
				FindProjectsDocument,
				variables,
				options
			) as Promise<FindProjectsQuery>;
		},
		getProject(variables: GetProjectQueryVariables, options?: C): Promise<GetProjectQuery> {
			return requester<GetProjectQuery, GetProjectQueryVariables>(
				...
				variables,
				options
			) as Promise<GetProjectQuery>;
		},
		findAllProjectTemplates(
			variables?: FindAllProjectTemplatesQueryVariables,
			options?: C
		): Promise<FindAllProjectTemplatesQuery> {
			return requester<FindAllProjectTemplatesQuery, FindAllProjectTemplatesQueryVariables>(
				FindAllProjectTemplatesDocument,
				variables,
				options
			) as Promise<FindAllProjectTemplatesQuery>;
		},
		createProject(
		...
		toggleEmote(
			variables: ToggleEmoteMutationVariables,
			options?: C
		): Promise<ToggleEmoteMutation> {
			return requester<ToggleEmoteMutation, ToggleEmoteMutationVariables>(
				ToggleEmoteDocument,
				variables,
				options
			) as Promise<ToggleEmoteMutation>;
		},
		setProjectMilestonesFromTemplate(
			variables: SetProjectMilestonesFromTemplateMutationVariables,
			options?: C
		): Promise<SetProjectMilestonesFromTemplateMutation> {
			return requester<
				SetProjectMilestonesFromTemplateMutation,
				SetProjectMilestonesFromTemplateMutationVariables
			>(
				SetProjectMilestonesFromTemplateDocument,
				variables,
				options
			) as Promise<SetProjectMilestonesFromTemplateMutation>;
		},
		updateProjectTask(
			variables: UpdateProjectTaskMutationVariables,
			options?: C
		): Promise<UpdateProjectTaskMutation> {
			return requester<UpdateProjectTaskMutation, UpdateProjectTaskMutationVariables>(
				UpdateProjectTaskDocument,
				variables,
				options
			) as Promise<UpdateProjectTaskMutation>;
		},
		deleteProjectTask(
			variables: DeleteProjectTaskMutationVariables,
			options?: C
		): Promise<DeleteProjectTaskMutation> {
			return requester<DeleteProjectTaskMutation, DeleteProjectTaskMutationVariables>(
				DeleteProjectTaskDocument,
				variables,
				options
			) as Promise<DeleteProjectTaskMutation>;
		},
		updateProjectFeature(
			variables: UpdateProjectFeatureMutationVariables,
			options?: C
		): Promise<UpdateProjectFeatureMutation> {
			return requester<UpdateProjectFeatureMutation, UpdateProjectFeatureMutationVariables>(
				UpdateProjectFeatureDocument,
				variables,
				options
			) as Promise<UpdateProjectFeatureMutation>;
		},
		deleteProjectFeature(
			variables: DeleteProjectFeatureMutationVariables,
			options?: C
		): Promise<DeleteProjectFeatureMutation> {
			return requester<DeleteProjectFeatureMutation, DeleteProjectFeatureMutationVariables>(
				DeleteProjectFeatureDocument,
				variables,
				options
			) as Promise<DeleteProjectFeatureMutation>;
		},
		...
		updateResourceSkill(
			variables: UpdateResourceSkillMutationVariables,
			options?: C
		): Promise<UpdateResourceSkillMutation> {
			return requester<UpdateResourceSkillMutation, UpdateResourceSkillMutationVariables>(
				UpdateResourceSkillDocument,
				variables,
				options
			) as Promise<UpdateResourceSkillMutation>;
		},
		deleteResourceSkill(
			variables: DeleteResourceSkillMutationVariables,
			options?: C
		): Promise<DeleteResourceSkillMutation> {
			return requester<DeleteResourceSkillMutation, DeleteResourceSkillMutationVariables>(
				DeleteResourceSkillDocument,
				variables,
				options
			) as Promise<DeleteResourceSkillMutation>;
		},
		createResource(
		...
		deleteResource(
			...
			return requester<DeleteResourceMutation, DeleteResourceMutationVariables>(
				DeleteResourceDocument,
				variables,
				options
			) as Promise<DeleteResourceMutation>;
		},
		...
		findAllResources(
			variables?: FindAllResourcesQueryVariables,
			options?: C
		): Promise<FindAllResourcesQuery> {
			return requester<FindAllResourcesQuery, FindAllResourcesQueryVariables>(
				FindAllResourcesDocument,
				variables,
				options
			) as Promise<FindAllResourcesQuery>;
		},
		findAllUsers(variables?: FindAllUsersQueryVariables, options?: C): Promise<FindAllUsersQuery> {
			return requester<FindAllUsersQuery, FindAllUsersQueryVariables>(
				FindAllUsersDocument,
				variables,
				options
			) as Promise<FindAllUsersQuery>;
		},
		currentUser(variables?: CurrentUserQueryVariables, options?: C): Promise<CurrentUserQuery> {
			return requester<CurrentUserQuery, CurrentUserQueryVariables>(
				CurrentUserDocument,
				variables,
				options
			) as Promise<CurrentUserQuery>;
		}
	};
}
