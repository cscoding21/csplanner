<script lang="ts">
  ...
  <Navbar fluid={true}>
    <NavBrand href="/">
      <span class="self-center whitespace-nowrap text-3xl font-semibold dark:text-white"><span class="text-md text-amber-500">cs</span>Planner</span>
      <svg xmlns="http://www.w3.org/2000/svg"  
            class="ml-1 w-8 h-8 sm:h-9 fill-amber-500" 
    ...
    <Dropdown placement="bottom" triggeredBy="#avatar-menu">
      ...
      <DropdownDivider />
      <DropdownItem>
        <button class="gb-initial" on:click={logoutUser}>Sign out</button>
        </DropdownItem>
    </Dropdown>
