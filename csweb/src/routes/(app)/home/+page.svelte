<script lang="ts">
    ...
    import ActivityDisplay from "./activities/ActivityDisplay.svelte";
...
<div class="p-4">
    ...
    <OrgStateChecker invert={false} stateToCheck="isReadyForProjects">
        ...
        <div class="grid grid-cols-3 gap-4">
            ...
            <CSSection>
                <SectionSubHeading>Recent Activity</SectionSubHeading>
                ...
                <ol class="divide-gray-200 mt-3 divide-y dark:divide-gray-700">
                    {#each activity.results as a, index}
                        <ActivityDisplay activity={a as Activity} />
                    {/each}
                </ol>
                {:else}
