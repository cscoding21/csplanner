<script lang="ts">
	...
	let posts = [
        { name: 'Snapshot', icon: ChartPieOutline, href: '#snapshot' },
        { name: 'Basics', icon: ScaleBalancedOutline, href: '#basics' },
        { name: 'DACI', icon: CalendarMonthOutline, href: '#daci' },
        { name: 'Features', icon: RectangleListOutline, href: '#features' },
