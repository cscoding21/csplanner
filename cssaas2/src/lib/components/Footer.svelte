      ...
      <div class="grid grid-cols-2 gap-8 lg:grid-cols-5">
          <div class="col-span-2">
              ...
              <ul class="flex mt-5 space-x-6">
                    <!-- FACEBOOK -->
                  <li>
                      <a href="#" target="_blank" class="text-gray-500 hover:text-gray-900 dark:hover:text-white dark:text-gray-400">
                  ...
                  <!-- TWITTER -->
                  <li>
                      <a href="https://x.com/cscoding21" target="_blank" class="text-gray-500 hover:text-gray-900 dark:hover:text-white dark:text-gray-400">
                  ...
                  <!-- GITHUB -->
                  <li>
                      <a href="https://github.com/cscoding21" target="_blank" class="text-gray-500 hover:text-gray-900 dark:hover:text-white dark:text-gray-400">
          ...
          <div class="lg:mx-auto">
              ...
              <ul class="text-gray-500 dark:text-gray-400">
                  <li class="mb-4">
                      <a href="#" target="_blank" class="hover:underline hover:text-gray-900 dark:hover:text-white">Discord Server</a>
                  </li>
                  <li class="mb-4">
                      <a href="https://x.com/cscoding21" target="_blank" class="hover:underline hover:text-gray-900 dark:hover:text-white">X (Twitter)</a>
                  </li>
                  <li class="mb-4">
                      <a href="#" target="_blank" class="hover:underline hover:text-gray-900 dark:hover:text-white">Facebook
                  </li>
                  <li class="mb-4">
                      <a href="#" target="_blank" class="hover:underline hover:text-gray-900 dark:hover:text-white">Contact Us</a>
                  </li>
              </ul>
          </div>
          <div class="lg:mx-auto">
