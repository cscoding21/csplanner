				...
				Tasks: []*project.ProjectMilestoneTask{
					{
						...
						ResourceIDs:     []string{"resource:barry"},
					},
					{
						ID:              utils.ValToRef(uuid.New().String()),
						Name:            "Signoff",
				...
				Tasks: []*project.ProjectMilestoneTask{
					{
						...
						ResourceIDs:     []string{"resource:yuri"},
					},
					{
						ID:              utils.ValToRef(uuid.New().String()),
						...
						Status:          milestonestatus.Accepted,
						RequiredSkillID: "td:project-management",
						ResourceIDs:     []string{"resource:brenda"},
					},
					{
						ID:              utils.ValToRef(uuid.New().String()),
						...
						ResourceIDs:     []string{"resource:adam"},
					},
					{
						ID:              utils.ValToRef(uuid.New().String()),
						...
						ResourceIDs:     []string{"resource:celine", "resource:zelda"},
					},
				},
			},
				...
				Tasks: []*project.ProjectMilestoneTask{
					{
						...
						ResourceIDs:     []string{"resource:zelda"},
					},
					{
						ID:              utils.ValToRef(uuid.New().String()),
						...
						ResourceIDs:     []string{"resource:chris"},
					},
					{
						ID:              utils.ValToRef(uuid.New().String()),
						...
						ResourceIDs:     []string{"resource:wendy"},
					},
					{
						ID:              utils.ValToRef(uuid.New().String()),
						Name:            "Testing",
...

			{
				...
				Tasks: []*project.ProjectMilestoneTask{
					...
					},
					{
						...
						ResourceIDs:     []string{"resource:tori"},
					},
				},
			},
		},
		...
		ProjectMilestones: []*project.ProjectMilestone{
			{
				...
				Tasks: []*project.ProjectMilestoneTask{
					...
					},
					{
						...
						ResourceIDs:     []string{"resource:jerry"},
					},
					{
						ID:              utils.ValToRef(fmt.Sprintf("task:%s", uuid.New().String())),
