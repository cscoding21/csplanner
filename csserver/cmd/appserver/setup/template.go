...
func CreateTestTemplates(ctx context.Context) error {
	...
	template := &projecttemplate.Projecttemplate{
		...
		Phases: []projecttemplate.ProjecttemplatePhase{
			...
			{ID: uuid.New().String(), Name: "Monitoring & Control", Description: "In the project management process, the third and fourth phases are not sequential in nature. The project monitoring and controlling phase run simultaneously with project execution, thereby ensuring that objectives and project deliverables are met.", PhaseOrder: 4},
