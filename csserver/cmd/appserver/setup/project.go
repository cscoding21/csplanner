				...
				Tasks: []*project.ProjectMilestoneTask{
					{
						...
						HourEstimate:     120,
						Status:           "new",
						RequiredSkillIDs: []string{"project-management", "requirements-gathering"},
						ResourceIDs:      []string{},
						StartDate:        nil,
						EndDate:          nil,
					},
					{
						...
						HourEstimate:     40,
						Status:           "new",
						RequiredSkillIDs: []string{"project-management"},
						ResourceIDs:      []string{},
						StartDate:        nil,
						EndDate:          nil,
					},
			...
			},
			{
				...
				Tasks: []*project.ProjectMilestoneTask{
					...
					},
					{
						...
						HourEstimate:     120,
						Status:           "new",
						RequiredSkillIDs: []string{"backend", "database", "security"},
						ResourceIDs:      []string{},
						StartDate:        nil,
						EndDate:          nil,
					},
				...
				Tasks: []*project.ProjectMilestoneTask{
					{
						...
						HourEstimate:     120,
						Status:           "new",
						RequiredSkillIDs: []string{"database"},
						ResourceIDs:      []string{},
						StartDate:        nil,
						EndDate:          nil,
					},
					{
						...
						HourEstimate:     120,
						Status:           "new",
						RequiredSkillIDs: []string{"backend", "database"},
						ResourceIDs:      []string{},
						StartDate:        nil,
						EndDate:          nil,
					},
					{
						...
						HourEstimate:     40,
						Status:           "new",
						RequiredSkillIDs: []string{"frontend", "ui"},
						ResourceIDs:      []string{},
						StartDate:        nil,
						EndDate:          nil,
					},
...

			{
				...
				Tasks: []*project.ProjectMilestoneTask{
					...
					},
					{
						...
						HourEstimate:     40,
						Status:           "new",
						RequiredSkillIDs: []string{"technical-writing"},
						ResourceIDs:      []string{},
						StartDate:        nil,
						EndDate:          nil,
					},
...

			{
				...
				Tasks: []*project.ProjectMilestoneTask{
					...
					},
					{
						...
						HourEstimate:     160,
						Status:           "new",
						RequiredSkillIDs: []string{"marketing", "content-writing"},
						ResourceIDs:      []string{},
						StartDate:        nil,
						EndDate:          nil,
					},
				...
				Tasks: []*project.ProjectMilestoneTask{
					{
						...
						Status:           "new",
						RequiredSkillIDs: []string{"requirements-gathering", "business-analysis"},
					...
					},
					{
						...
						Status:           "new",
						RequiredSkillIDs: []string{"content-writing"},
						ResourceIDs:      []string{allResources.Results[rand.Intn(*allResources.Pagination.TotalResults-1)].ID},
					...
					},
					{
						...
						Status:           "new",
						RequiredSkillIDs: []string{"communications"},
						ResourceIDs:      []string{allResources.Results[rand.Intn(*allResources.Pagination.TotalResults-1)].ID},
					...
					},
					{
						...
						Status:           "new",
						RequiredSkillIDs: []string{"video-editing"},
						ResourceIDs:      []string{allResources.Results[rand.Intn(*allResources.Pagination.TotalResults-1)].ID},
					...
					},
					{
						...
						Status:           "new",
						RequiredSkillIDs: []string{"video-editing", "frontend"},
						ResourceIDs:      []string{allResources.Results[rand.Intn(*allResources.Pagination.TotalResults-1)].ID},
					...
					},
					{
						...
						HourEstimate:     rand.Intn(3),
						Status:           "new",
						RequiredSkillIDs: []string{"marketing"},
						ResourceIDs:      []string{allResources.Results[rand.Intn(*allResources.Pagination.TotalResults-1)].ID},
